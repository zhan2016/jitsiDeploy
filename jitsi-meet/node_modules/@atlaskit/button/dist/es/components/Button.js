...
var _templateObject = _taggedTemplateLiteral(['', ''], ['', '']),
    _templateObject2 = _taggedTemplateLiteral(['a&{ ', ' }'], ['a&{ ', ' }']),
...
var createStyledComponent = function createStyledComponent() {
  ...
  var component = styled(CustomComponentProxy)(_templateObject3, getButtonStyles);
...
var Button = function (_Component) {
  ...
  Button.prototype.render = function render() {
    ...
    return React.createElement(
      StyledComponent,
      _extends({ innerRef: innerRef }, buttonProps),
      React.createElement(
        ButtonWrapper,
...
Button.propTypes = {
  ...
  appearance: PropTypes.oneOf(['default', 'danger', 'link', 'primary', 'subtle', 'subtle-link', 'warning', 'help']),
