...
Detailed docs and example usage can be found [here](https://aui-cdn.atlassian.com/atlaskit/stories/@atlaskit/field-text/4.0.1/).

## Installation

```sh
npm install @atlaskit/field-text
```
