...
var Svg = function Svg(props) {
  return React.createElement('svg', _extends({ height: '100%', version: '1.1', viewBox: '0 0 8 8', width: '100%', xmlns: 'http://www.w3.org/2000/svg' }, props));
};

var ApprovedCircle = styled.circle(_templateObject, themed({ light: colors.G400, dark: colors.G300 }));
var ApprovedPath = styled.path(_templateObject, colors.background);
var DeclinedCircle = styled.circle(_templateObject, themed({ light: colors.R400, dark: colors.R300 }));
var DeclinedPath = styled.path(_templateObject, colors.background);
var LockedCircle = styled.circle(_templateObject, themed({ light: colors.N40, dark: colors.DN800 }));
var LockedPath = styled.path(_templateObject, themed({ light: colors.N500, dark: colors.DN30 }));
